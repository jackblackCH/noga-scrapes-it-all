    ...
    <div className="space-y-8 max-w-2xl mx-auto">
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          protein industry. Use any of our resume templates to get started, or work with one of our
          professionals to make sure your application stands out.
        </p>
        ...
        <p>
          <strong>Learn how to break into the alt protein industry.</strong> Be strategic with your
          transition: start with these resources for professionals with backgrounds in engineering,
          biotech, and large food corporations. If you&apos;re not sure where to start,{' '}
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          seekers. Featured job posts on Alt Protein Careers get ~3x visibility compared to regular
          posts.
        </p>

        <p>
          <strong>Get help with targeted search.</strong> We headhunt top talent to the alt protein
          companies we work with. We are ruthlessly determined, creative and meticulous when it
          comes to finding and hiring them. Learn more about our recruiting services{' '}
      ...
      <section className="space-y-4">
        ...
        <div>
          ...
          <p>
            ...
            investing to working as a marketing leader in financial technology. Noga holds an M.B.A.
            from the Stanford Graduate School of Business. Additionally, she served three years in
            the Israeli military as a commanding officer (rank: Lieutenant.)
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p>
            Anna has been at the nexus of recruiting and alternative proteins, biomanufacturing, and
            agri-food tech for nearly a decade. She is a passionate, well-known global recruiter in
            the alternative protein and future food space, with extensive recruiting and leadership
            experience at firms like Charlton Morris and CSG Global. Anna resides in the UK and
            serves as the London Ambassador for Food Hack. Anna holds a BA in Business and
            Management from Leeds Beckett University.
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p>
            Sacha spent several years working in advertising at Google before pursuing her M.B.A. at
            Harvard Business School. Since graduating from Harvard, she has spent time with
            ...
            experience to helping others find careers they&apos;re excited about in the alt protein
            space.
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p>
            Over her two-decade-long career, Jennifer has become an established thought leader, her
            influence spanning diverse organizational landscapes from Fortune 500 corporations to
            grassroots nonprofits. As a long-time advocate for environmental and animal protection,
            her personal mission is to enable the proliferation of sustainable, humane solutions for
            the masses, with a key focus on alternative proteins and materials. Jennifer holds an
            M.B.A in Business & Sustainability from Yale School of Management and an M.A. in
        ...
        <div>
          ...
          <p>
            ...
            making the world a better place by understanding environmental change: she attended COP
            27 in Egypt, where she researched sustainable food production, and worked on global
            energy research for the Atlantic Council. Sarah holds a BA in International Studies,
            with a certificate in Jewish Studies and a minor in Environmental Science, from Indiana
            University.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            planet, and is especially enthusiastic about battling food insecurity and malnutrition,
            and diving into the details of cultivated meat. In addition to her work with Alt Protein
            Careers, Shimoi is a fellow at From Fauna, a non-profit dedicated to advancing the field
            of cultivated meat, and a full-time high school student in Toronto, Canada.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            excellent recruiter, networker, and motivator. Ruvi&apos;s primary areas of focus at Alt
            Protein Careers are bringing people together and managing pawjects.
          </p>
        </div>
      </section>
    </div>
